...
async function main() {
  ...
  const order1 = await prisma.order.upsert({
    ...
    create: {
      ...
      assignedAt: new Date(),
      items: {
        create: [{ name: "Pizza Large", quantity: 1, unitPrice: 800, totalPrice: 800 }],
      },
    },
  });
  ...
  const order2 = await prisma.order.upsert({
    ...
    create: {
      ...
      assignedAt: new Date(),
      items: {
        create: [{ name: "Burger", quantity: 2, unitPrice: 250, totalPrice: 500 }],
      },
    },
  });
  ...
  const order3 = await prisma.order.upsert({
    ...
    create: {
      ...
      deliveredAt: new Date(),
      items: {
        create: [{ name: "Shawarma", quantity: 3, unitPrice: 200, totalPrice: 600 }],
      },
    },
  });
  ...
  const order4 = await prisma.order.upsert({
    ...
    create: {
      ...
      deliveredAt: new Date(),
      items: {
        create: [{ name: "Family Deal", quantity: 1, unitPrice: 1200, totalPrice: 1200 }],
      },
    },
  });
    },
