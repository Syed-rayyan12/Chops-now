        ...
        <div className="flex items-center justify-between gap-4">
          ...
          <div className="flex items-center space-x-4 w-full">
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-80 bg-white border-none max-h-[400px] overflow-y-auto">
                ...
                {realNotifications.length === 0 ? (
                  ...
                  realNotifications.slice(0, 10).map((notification) => (
                    <DropdownMenuItem
                      key={notification.id}
                      className={`text-foreground border-b border-gray-400 rounded-none cursor-pointer ${
                        !notification.isRead ? "bg-[#DCFCE7]" : "bg-white"
                      }`}
